...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='end',
            field=models.DecimalField(blank=True, decimal_places=2, help_text='Left empty for left-closed range', max_digits=12, null=True),
        ),
        migrations.AlterField(
            model_name='valuerange',
            name='start',
            field=models.DecimalField(blank=True, decimal_places=2, help_text='Left empty for right-closed range', max_digits=12, null=True),
        ),
    ]
