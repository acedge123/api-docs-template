...
WSGI_APPLICATION = "hfcscoringengine.wsgi.application"
...
X_FRAME_OPTIONS = None  # controlled via CSP frame-ancestors (see middleware)
...
# TODO: Provide admins
ADMINS = [("""Denys Chura""", "denys.chura@perfectial.com")]
