    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=200,
                        validators=[scoringengine.models.validate_field_name],
                    ),
                ),
                (
                    "weight",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "rule",
                    models.CharField(
                        help_text='Rule should start with "If" and may contain only valid numbers, questions "Field names" in curly braces (e.g. {field_name}) combined with arithmetic (+, -, *, /), comparison (>, <, ==, !=, >=, <=) and logical operations (and, or, not)',
                        max_length=200,
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("number", "owner"), name="unique_number"
            ),
        ),
        migrations.AddConstraint(
            model_name="question",
        ...
        migrations.AddConstraint(
            model_name="choice",
            constraint=models.UniqueConstraint(
                fields=("question", "text"), name="unique_choice"
            ),
        ),
        migrations.AddConstraint(
            model_name="answer",
